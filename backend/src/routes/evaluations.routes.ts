...
import { assertCourseAccess, assertModuleUnlocked } from "../services/courses.service";
...
evaluationsRouter.post(
  ...
  asyncHandler(async (req, res) => {
    ...
    await assertModuleUnlocked(req.currentUser!.id, evaluation.module.courseId, evaluation.module.id);
